	...
	<div class="portfolio">		
				...
				<div id="portitems4">
					...
					?>
							...
							<div class="item4 <?php echo $catlist ?>" data-category="<?php echo $catlist ?>">
								...
								<div class="image">
									...
									<img src="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php echo $full_image[0]; ?>&amp;h=130&amp;w=209" alt="<?php the_title(); ?>">
								</div>
