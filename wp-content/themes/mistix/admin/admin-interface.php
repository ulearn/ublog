...
function of_load_only() {
	...
	wp_register_script('editorC', ADMIN_DIR . "/js/tinymce/jscripts/tiny_mce/tiny_mce.js", 'jquery');	
    wp_enqueue_script( 'editorC');	
	function my_custom_js() {
    echo '<script type="text/javascript">tinyMCE.init({
			// General options
			mode : "textareas",
			editor_selector : "showEditorTextArea",
			theme : "advanced",
			plugins : "autolink,lists,spellchecker,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template",

			// Theme options
			theme_advanced_buttons1 : "bold,italic,underline,|,justifyleft,justifycenter,justifyright,justifyfull,|,undo,redo,|,link,unlink,anchor,image,",
...
public static function optionsframework_slider_function($id,$std,$oldorder,$order,$int){
	...
	$slider .= '<label>Description (For Nivo Slideshow only)</label>';
