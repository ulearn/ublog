<?php
/*
Template Name: Full Width Page with Thumb Nivo slider
*/
?>
	...
	<?php $slides = $data['demo_slider']; 
		...
		foreach ($slides as $slide) { 
          ...
          if($slide['url'] != '') :
             ...
             if($slide['link'] != '') : ?>
               <a href="<?php echo $slide['link']; ?>"><img src="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php echo $slide['url']; ?>&amp;h=380&amp;w=940" title="<?php echo stripText($slide['description']); ?>" rel="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php echo $slide['url']; ?>&amp;h=65&amp;w=110"/></a>
            <?php else: ?>
                <img src="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php echo $slide['url']; ?>&amp;h=380&amp;w=940" title="<?php echo stripText($slide['description']); ?>" rel="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php echo $slide['url']; ?>&amp;h=65&amp;w=110"/>
            <?php endif; ?>
