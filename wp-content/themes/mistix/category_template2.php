...
<div id="mainwrap">
	...
	<div id="main" class="clearfix blogFullWidth">
		...
		<div class="pad"></div>	
			...
			<div class="content">
				...
				<div class="slider-category">
									...
									foreach ($attachments as $attachment) {
										...
										$image =  wp_get_attachment_image_src( $attachment->ID, 'full' ); ?>	
											...
											<div class="slider-item">
												<img src="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php echo $image[0] ?>&amp;h=195&amp;w=400" />					
				  ...
				  <a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><img src="<?php echo get_template_directory_uri() ?>/js/timthumb.php?src=<?php echo $image ?>&amp;h=195&amp;w=400" alt="<?php the_title(); ?>"></a>
				  <?php }?>
					<div class="entry">
						<div class = "meta">
						...
						<p class="content"><?php echo shortcontent('[', ']', '', $post->post_content ,400);?> ...</p>
						<div class="line"></div>
						...
						<div class="socialsingle">						
								...
								<p class="time"><a href="<?php echo home_url() ?>/<?php the_time('Y') ?>/<?php the_time('m') ?>/<?php the_time('j') ?>"><?php the_time('F j, Y') ?></a></p>
