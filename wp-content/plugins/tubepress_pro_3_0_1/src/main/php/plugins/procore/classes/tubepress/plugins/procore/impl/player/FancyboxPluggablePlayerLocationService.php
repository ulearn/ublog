 ...
 */
class tubepress_plugins_procore_impl_player_FancyboxPluggablePlayerLocationService implements tubepress_spi_player_PluggablePlayerLocationService
{
    /**
    ...
    {
        return $themeHandler->getTemplateInstance('players/fancybox.tpl.php', TUBEPRESS_ROOT . '/src/main/resources/default-themes/default');
    }
    ...
    {
        return '/src/main/web/players/fancybox/fancybox.js';
    }
    ...
    {
        return 'with Fancybox';                                        //>(translatable)<
    }
}