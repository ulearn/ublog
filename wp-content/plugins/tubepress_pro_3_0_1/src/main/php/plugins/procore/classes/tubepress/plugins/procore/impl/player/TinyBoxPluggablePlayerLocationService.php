 ...
 */
class tubepress_plugins_procore_impl_player_TinyBoxPluggablePlayerLocationService implements tubepress_spi_player_PluggablePlayerLocationService
{
    /**
    ...
    {
        return $themeHandler->getTemplateInstance('players/tinybox.tpl.php', TUBEPRESS_ROOT . '/src/main/resources/default-themes/default');
    }
    ...
    {
        return '/src/main/web/players/tinybox/tinybox.js';
    }
    ...
    {
        return 'with TinyBox';                                        //>(translatable)<
    }
}